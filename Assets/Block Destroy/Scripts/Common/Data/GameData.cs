...
public class GameData {
    ...
    // Arcade mode best scores
    public static int BestScoreArcade {
        get { return PlayerPrefs.GetInt("BestScoreArcade", 0); }
        set { PlayerPrefs.SetInt("BestScoreArcade", value); }
    }

    public static int BestTurnArcade {
        get { return PlayerPrefs.GetInt("BestTurnArcade", 0); }
        set { PlayerPrefs.SetInt("BestTurnArcade", value); }
    }
    ...
    public static string CountryCode {
        get { return PlayerPrefs.GetString("CountryCode", ""); }
    ...
    public static bool NoAds {
        get { return PlayerPrefs2.GetBool("NoAds"); }
        set { PlayerPrefs2.SetBool("NoAds", value); }
    }

    public static bool IsPremium {
        get { return PlayerPrefs2.GetBool("IsPremium"); }
        set { PlayerPrefs2.SetBool("IsPremium", value); }
    }
