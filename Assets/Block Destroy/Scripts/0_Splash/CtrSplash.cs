...
public class CtrSplash : CtrBase {
    public Image imageCompanyLogo;

    void Awake () {
        imageCompanyLogo.DOFade(0f, 0f);
    }
    ...
    IEnumerator StartCo () {
        ...
        imageCompanyLogo.DOFade(1, 0.25f).SetEase(Ease.OutCubic);
        yield return new WaitForSeconds(2f);

        imageCompanyLogo.DOFade(0, 0.2f).SetEase(Ease.InCubic);
